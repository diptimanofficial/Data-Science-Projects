...
DATA = r"C:\Users\vikra\OneDrive\Desktop\Diptiman_DS\BAM_DS\data_processed\final_dataset.parquet"
...
def run():
    ...
    # Save the PCA Output
    OUT = r"C:\Users\vikra\OneDrive\Desktop\Diptiman_DS\BAM_DS\data_processed\final_dataset_with_pca.parquet"
    df.to_parquet(OUT)
